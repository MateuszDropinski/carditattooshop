...
const Welcome = () => (
    <Wrapper>
        <Logo src='https://mateuszdropinski.github.io/carditattooshop/build/assets/logo_1.png' alt='Cardi Tattoo Shop' />
        <StaticNavbar />
        <MobileNavbar />
...
const Wrapper = styled.section`
    ...
    background-image: url('https://mateuszdropinski.github.io/carditattooshop/build/assets/background_1.jpg');
